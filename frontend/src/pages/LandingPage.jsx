...
import SignUp from '../components/SignUp.jsx'; // Adjust path if needed
  ...
  <header className={landingPageStyles.header}>
    <div className={landingPageStyles.headerContainer}>
      <div className={landingPageStyles.logoContainer}>
        ...
        <LayoutTemplate className={landingPageStyles.logoIcon} />
...
<div className={landingPageStyles.statsContainer}>
  {[
    ...
    { value: '4.9/5', label: 'User Rating', gradient: 'from-orange-500 to-red-500' },
...
<footer className={landingPageStyles.footer}>
  <div className={landingPageStyles.footerContainer}>
    <p className={landingPageStyles.footerText}>
      ...
      <a 
        href="https://magical-griffin-458889.netlify.app/" 
        target="_blank" 
